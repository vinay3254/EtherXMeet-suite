export default function VideoBackground() {
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: -1, width: '100vw', height: '100vh', pointerEvents: 'none', background: '#141414' }}>
      <video
        autoPlay
        muted
        loop
      ...
      {/* gold color blend — replaces any remaining hue with #d4af37 */}
      <div style={{
        position: 'absolute',
        inset: 0,
        background: '#d4af37',
